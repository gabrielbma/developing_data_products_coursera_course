...
The main goal of this application is to allow students to easily inspect the Iris dataset by providing built-in features such as dataset summary, plots and some machine learning models. That way, a student just starting learnining this dataset can quickly take out information of it.
